 ...
 */
class Version20170929212157 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE moduleInfo (id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, guide LONGTEXT NOT NULL, available_configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE modules (id BIGINT AUTO_INCREMENT NOT NULL, page_id BIGINT NOT NULL, module_info_id BIGINT NOT NULL, size INT NOT NULL, rank INT NOT NULL, configuration LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_2EB743D7C4663E4 (page_id), INDEX IDX_2EB743D7F6F0FFE1 (module_info_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
