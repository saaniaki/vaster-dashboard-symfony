 ...
 */
class Version20170622181707 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE moduleInfo (id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE modules (id BIGINT AUTO_INCREMENT NOT NULL, page_id BIGINT NOT NULL, module_info_id BIGINT NOT NULL, rank INT NOT NULL, INDEX IDX_2EB743D7C4663E4 (page_id), INDEX IDX_2EB743D7F6F0FFE1 (module_info_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
