...
/* WEBPACK VAR INJECTION */(function($) {var cancelSearch = "<div class='input-group-btn dropup' id='cancelSearch' >" + "<button type='button' class='btn btn-default' style='height: 33px; width: 20px; padding: 2px;'><span class='glyphicon glyphicon-remove'></span></button>" + "</div>";
...
function renderTable(ajaxPath) {
    $.ajax({
        ...
        success: function success(data) {
            ...
            if (data.users.length === 0) alert('No result founded! :(');
            ...
            $.each(data.users, function (key, user) {
                ...
                if (user.location !== null) {
                    ...
                    locationLink = "<a data-toggle='tooltip' data-placement='bottom' title='" + locationTime + "' style='margin-left: 7px;' target='_blank' class='label label-success' href='" + mapLink + user.location.latitude + "," + user.location.longitude + "'>map</a>";
                }
                if (user.lastName === null) user.lastName = '';
                if (user.email === null) user.email = '';
                if (user.type === null) user.type = '';else if (user.type === 'Internal') user.type = "<span class='label label-info'>Internal</span>";
                ...
                $("#ajaxTbody").append("<tr data-userid='" + user.id + "' class='user'>" +
                //"<td data-userid='"+user.id+"' class='fnameColumn'><span class='id'>" + user.id + "</span>" + user.firstName + "</td>" +
                "<td class='fnameColumn'>" + user.firstName + "</td>" + "<td class='lnameColumn'>" + user.lastName + "</td>" + "<td class='phoneColumn'>" + user.phone + "</td>" + "<td class='emailColumn'>" + user.email + "</td>" + "<td class='createdColumn'>" + user.createdTime.date + "</td>" + "<td class='typeColumn'>" + user.type + "</td>" + "<td class='orgColumn' style='text-align: center;'>" + user.profession.available + "</td>" + "<td class='osColumn'>" + user.device + "</td>" + "<td class='lastSeenColumn'>" + user.lastSeen + "</td>" + "<td>" + locationLink + "</td>" + "</tr>" //$
                );
...
function getOriginalUser(id) {
    currUserID = id;
    return $.grep(originalUsers, function (e) {
        return e.id === id;
    })[0];
}
...
$("#edit-selectable-modal-undo").on("click", function () {
    ...
    if (originalUser.type === null) $("#modal-type").css('color', 'rgb(165, 165, 165)');
...
$(document).ready(function () {
    ...
    $('#search-result-section').on("scroll", function () {
        ...
        if (selector.length !== 0) {
            ...
            if (itemOffset < 0) $('#item-fixed').show().css('top', $(this).scrollTop());else $('#item-fixed').hide().css('top', $(this).scrollTop());
        }
    });
    ...
    $('#search').click(function () {
        ...
        keyword = $('#keyword').val();
        if (option === 'contains') keyword = '%25' + keyword + '%25';else if (option === 'starts') keyword = keyword + '%25';else if (option === 'ends') keyword = '%25' + keyword;

        loadTable(keyword);

        if ($('#cancelSearch').length !== 1) $('#searchBar').prepend(cancelSearch);
    });
    ...
    function printField(field, selector, msg) {
        if (field === "" || field === null) $(selector).html("<span style='color: rgb(165, 165, 165); font-weight: normal;'>" + msg + "</span>");else $(selector).text(field);
    ...
    function printServiceTable(obj) {
        ...
        for (var i in obj) {
            ...
            if (obj[i].status) statusWord = "available";

            rows += "<tr>" + "<td>" + numToDay[obj[i].day] + "</td>" + "<td>" + msToTime(obj[i].from) + "</td>" + "<td>" + msToTime(obj[i].to) + "</td>" + "<td>" + statusWord + "</td>" + "</tr>";
        }

        return "<table id='modal-service-time-table' class='table table-striped table-hover' style=' margin-top: 15px;'>" + "<thead>" + "<tr>" + "<th><span>Day</span></th>" + "<th><span>Start</span></th>" + "<th><span>End</span></th>" + "<th><span>Availability</span></th>" + "</tr>" + "</thead>" + "<tbody id='service-time'>" + rows + "</tbody>" + "</table>";
    }
    ...
    $("#ajaxTbody").on("click", ".user", function () {
        ...
        if (user.profession.website === "" || user.profession.website === null) $('#modal-website').html("<span style='color: rgb(165, 165, 165); font-weight: normal;'>no value</span>");else $('#modal-website').html("<a href='http://" + user.profession.website + "'>" + user.profession.website + "</a>"); //check for http
        ...
        if (latitude !== null && longitude !== null && latitude !== 0 && longitude !== 0) {
            locationLink = "<a data-toggle='tooltip' data-placement='bottom' title='" + locationTime + "' style='margin-left: 7px;' target='_blank' class='label label-success' href='" + mapLink + user.profession.homeLocation.latitude + "," + user.profession.homeLocation.longitude + "'>map</a>";
        ...
        if (user.socialNetworks.length !== 0) {
            ...
            for (var k in user.socialNetworks) {
                $('#modal-network').html("<span><a href='" + networks[k].url + "'>" + networks[k].name + " (" + networks[k].type + ")" + "</a></span>");
            }
        } else {
        ...
        if (user.serviceTime.length !== 0) {
            ...
            for (var i in row) {
                $('#service-time').append("<tr>" + "<td>" + row[i].day + "</td>" + "<td>" + row[i].start.substring(0, 5) + "</td>" + "<td>" + row[i].end.substring(0, 5) + "</td>" + "<td>" + row[i].availability + "</td>" + "</tr>");
            }
        ...
        if (user.locHistory.length !== 0) {
            ...
            for (index in row) {
                ...
                locationLink = "<a target='_blank' class='label label-success' href='" + mapLink + row[index].latitude + "," + row[index].longitude + "'>map</a>";

                rowHTML = "<tr id='locationNumber-" + index + "' >" + "<td>" + row[index].createdtime.date + "</td>" + "<td>" + row[index].latitude + "</td>" + "<td>" + row[index].longitude + "</td>" + "<td>" + locationLink + "</td>" + "</tr>";
        ...
        if (user.searches.length !== 0) {
            ...
            for (var index in row) {
                ...
                $('#modal-searches').append("<tr id='searchNumber-" + index + "'>" + "<td>" + row[index].createdtime.date + "</td>" + "<td>" + row[index].searchquery + "</td>" + "<td>" + locationLink + "</td>" + "</tr>");
                ...
                for (j in results) {
                    ...
                    if (element.hasOwnProperty('location')) {
                        locationLink = "<a target='_blank' class='label label-success' href='" + mapLink + element.location.lat + "," + element.location.lon + "'>map</a>";
                    } else {
                    ...
                    if (element.hasOwnProperty('resultMetaData')) {
                        metaData = "<div class='search-result-box'><span class='title'>Meta Data</span><hr>" + printSearchField('Category', element.resultMetaData.category) + printSearchField('CloudSearchScore', element.resultMetaData.cloudSearchScore) + printSearchField('VasterSearchScore', element.resultMetaData.vasterSearchScore) + "</div>";
                    } else {
                    ...
                    bilAdd = '';
                    if (element.hasOwnProperty('resultMetaData')) {
                        bilAdd = "<div class='search-result-box'><span class='title'>Address</span><hr>" + printSearchField('Address', element.billingAddress.address) + printSearchField('City', element.billingAddress.city) + printSearchField('Country', element.billingAddress.country) + printSearchField('PostalCode', element.billingAddress.postalCode) + printSearchField('Region', element.billingAddress.region) + "</div>";
                    } else {
                    ...
                    compInfo = '';
                    if (element.hasOwnProperty('resultMetaData')) {
                        compInfo = "<div class='search-result-box'><span class='title'>Company Info</span><hr>" + printSearchField('Name', element.companyInfo.name) + printSearchField('Website', element.companyInfo.website) + "</div>";
                    } else {
                        console.log("[" + index + "] [" + j + "] " + row[index].searchquery + " " + element.name + " no company info");
                    }

                    items[j] = "<div class='panel panel-default'>" + "<div class='panel-heading' role='tab' id='heading-" + element.vid + "'>" + "<h4 class='panel-title'>" + "<a class='collapsed' role='button' data-toggle='collapse' data-parent='#modal-searches-result' href='#collapse-" + results[j].vid + "' aria-expanded='false' aria-controls='collapse-" + results[j].vid + "'>" + element.name + "</a>" + "</h4>" + "</div>" + "<div id='collapse-" + element.vid + "' class='panel-collapse collapse' role='tabpanel' aria-labelledby='heading-" + results[j].vid + "'>" + "<div class='panel-body' style='padding: 8px;'>" + metaData + "<div class='search-result-box'><span class='title'>General</span><hr>" + printSearchField('Title', element.title) + printSearchField('Expertise', element.expertise) + printSearchField('Gender', element.gender) + printSearchField('Ranking', element.ranking.ranking) + printSearchField('Votes', element.ranking.votes) + printSearchField('About', element.about) + printSearchField('Location', locationLink) + "</div>" + compInfo + bilAdd + "<div class='search-result-box'><span class='title'>Service</span><hr>" + printSearchField('Service Rate', element.serviceRate) + printServiceTable(element.serviceTimes) + "</div>" + "</div></div></div>";
                }
